...
int main()
{
    ...
    // Get user input for age first
    cout << "Enter age: ";
    cin >> age;

    // Now we can check if the user is an adult
    isAdult = (age > 18 && age < 99);
    cout << (isAdult ? "Valid age. You are an adult.\n" : "Invalid age. You are not an adult.\n");
