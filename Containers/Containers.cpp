...
int main()
{
    string fruits[5] = { "Banana", "Strawberry", "Chikoo", "Kiwi", "Mango"};
    ...
    string chemicals[5] = { "mercury", "hydrochoric acid", "chlorine", "bromine", "table salt" };
    ...
    map<string, int> pet = { {"Dogs", 23}, {"Chameleons", 3}, { "Turtle", 1 }};
